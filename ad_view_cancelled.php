...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>View Cancelled Order Details</h1>
        <nav>
            <ol class="breadcrumb">
            ...
            <div class="card col-md-8 mx-auto">
                <div class="row">
                    <div class="card-body col-md-7"><br>
                        ...
                        <h5><b>Total: </b>Php: <?= number_format($cprice,2); ?></h5>
                        <h5><b>Method: </b> <?= $cpmode; ?></h5>
                        <h5><b>Address: </b> <?= $caddress; ?></h5>
                        <h5><b>Phone: </b> <?= $cphone; ?></h5>
                    </div>

                    <div class="card-body col-md-5" style="background-image: url('images/logo.jpg'); background-size: 100% 100%;">
                    </div>
                </div>
            </div>
    </section>
