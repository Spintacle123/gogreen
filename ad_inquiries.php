  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="ad_inquiries.php">Inquiries<a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                            ...
                            <?php while ($row = $result->fetch_assoc()) { ?>
                                <tr>
                                  ...
                                  <td style="text-align: center">
                                    <a href="ad_send_email.php?send=<?= $row['id']; ?>" type="button" class="btn btn-success">Respond<i class="bx bxs-edit"></i></a>
                                  </td>
                                </tr>
                            <?php } ?>
                        </tbody>
