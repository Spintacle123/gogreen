                ...
                <!-- <table id="data-table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 14px"><?= $row['products']; ?></td>
                            <td style="font-size: 14px"><?= $row['pmode']; ?></td>
                            <td style="font-size: 14px"><strong>Php:</strong><?= number_format($row['amount_paid'],2); ?></td>
                        </tr>
                    </tbody>
                    <?php } ?>
                </table> -->
